...
if __name__ == '__main__':
    ...
    p.add_argument('--dataset', default='DFGC', type=str, help='dataset')
    p.add_argument('--output_dir', default='E:/Downloads/DiffMIC-main/dataset/FaceForensics++/manipulated_sequences', type=str, help='path to the ouput data')
    ...
    p.add_argument('--bs', default=8, type=int, help='batch size')
    ...
    video_list += glob.glob(join('FaceForensics++', 'manipulated_sequences' , 'Deepfakes', 'c23', 'videos','*.mp4'), recursive=True)
    video_list += glob.glob(join('FaceForensics++', 'manipulated_sequences' , 'Face2Face', 'c23', 'videos','*.mp4'), recursive=True)      
